...
public class FXMLPrincipalUsuarioController implements Initializable {
 ...
 public void inicializarInformacion(Usuario usuarioSesion){
    ...
    @FXML
    private void clicAdministrarTienda(ActionEvent event) {
   try{
        Stage escenarioAdmin = new Stage();
        Parent vista = FXMLLoader.load(ExpendioBebidas.class.getResource("vista/FXMLAdministrarTiendaYProductos.fxml"));
        Scene escena= new Scene(vista);
        escenarioAdmin.setScene(escena);
        escenarioAdmin.setTitle("Administrar tienda y productos");
